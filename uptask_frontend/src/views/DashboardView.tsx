...
export default function DashboardView() {
  ...
  console.log(data)
  if (data && user) return ( //esto lo que hace es que si tiene data y usuario tiene algo retorna algo
    <>
              ...
              <div className="flex shrink-0 items-center gap-x-6">
                <Menu as="div" className="relative flex-none">
                  <Menu.Button className="-m-2.5 block p-2.5 text-gray-500 hover:text-gray-900">
                    ...
                    <EllipsisVerticalIcon className="h-9 w-9" aria-hidden="true" /> {/** Esto es para el menu de los tres puntos en vertical */}
                  </Menu.Button>
                  <Transition as={Fragment} enter="transition ease-out duration-100"
                    ...
                    >
                      ...
                      )} {/**verifica para ver si manager es igual al usuario actual y si es igual muestra la seccion de eliminar o editar el proyecto */}
