        ...
        <>
            ...
            <nav className="my-5 flex gap-3">
                ...
                font-bold cursor-pointer transition-colors"
                    onClick={() => navigate(location.pathname + '?addMember=true')} //Esa línea abre una ventana modal (o activa una vista condicional) agregando un parámetro a la URL mediante search params (parámetros de consulta).
                >
                    Agregar Colaborador
                </button>
