...
export default function DeleteProjectModal() {
    ...
    //aca los que hacemos es multitasking para hacer dos mutaciones diferentes y no solo una
    const handleForm = async (formData: CheckPasswordForm) => {
        await checkUserPasswordMutation.mutateAsync(formData) //se pone mutateAsync para que esta funcion sea asincrona
        await deleteProjectMutation.mutateAsync(deleteProjectId)
        
        /*Primero checkeamos el password*/
        /*segundo eliminamos el proyecto pasando el id*/
    }
