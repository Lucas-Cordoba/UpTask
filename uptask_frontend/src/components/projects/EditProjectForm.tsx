...
export default function EditProjectForm({data, projectId} : EditProjectFormProps) {
    ...
    const handleForm = (formData: ProjectFormData) => {
        const data = {
            formData,
            projectId
        } //hacemos este data para poder pasarle los datos del form y el id del project porque sino mutate no me acepta dos parametros
        mutate(data) //mutate solo toma una variable
    }
